...
> local, bilingual (zh/en), self-reflection-grade.
>
> [中文](./README.zh.md)
...
Paths are macOS-style. Linux/Windows paths haven't been tested yet — if you
are a code agent running on another OS, feel free to probe the equivalent
locations yourself and adapt the extractor.
